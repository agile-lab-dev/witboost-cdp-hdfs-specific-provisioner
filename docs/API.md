...
```javaURL obj = new URL("/{{version}}/provision");
...
r = requests.post('/{{version}}/provision', headers = headers)
...
```shell
# You can also use wget
curl -X GET /{{version}}/provision/{token}/status \
  -H 'Accept: application/json'
...
fetch('/{{version}}/provision/{token}/status',
{
  method: 'GET',
...
```java
URL obj = new URL("/{{version}}/provision/{token}/status");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
...
r = requests.get('/{{version}}/provision/{token}/status', headers = headers)
...
```java
URL obj = new URL("/{{version}}/validate");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
r = requests.post('/{{version}}/validate', headers = headers)
...
```javaURL obj = new URL("/{{version}}/unprovision");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
r = requests.post('/{{version}}/unprovision', headers = headers)
...
```java
URL obj = new URL("/{{version}}/updateacl");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
r = requests.post('/{{version}}/updateacl', headers = headers)
