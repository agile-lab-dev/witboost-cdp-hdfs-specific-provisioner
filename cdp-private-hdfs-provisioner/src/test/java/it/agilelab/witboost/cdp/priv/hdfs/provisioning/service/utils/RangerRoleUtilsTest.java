...
public class RangerRoleUtilsTest {
    ...
    public void testNewRangerRole() {
        ...
        var expectedUsers =
                List.of(
                        new RangerRole.RoleMember("user1", false),
                        new RangerRole.RoleMember("deployUser", true));
    ...
    public void testExistingRangerRole() {
        ...
        existingRangerRole.setUsers(
                List.of(
                        new RangerRole.RoleMember("user1", false),
                        new RangerRole.RoleMember("deployUser1", true)));
        existingRangerRole.setGroups(List.of(new RangerRole.RoleMember("group1", false)));
        var expectedUsers =
                List.of(
                        new RangerRole.RoleMember("user2", false),
                        new RangerRole.RoleMember("deployUser1", true));
        var expectedGroups = List.of(new RangerRole.RoleMember("group2", false));

        var actualRes =
                RangerRoleUtils.rangerRole(existingRangerRole, List.of("user2"), List.of("group2"));
